...
namespace Test {
	...
	private:
		long _pass; // Count passed test methods for all test classes
		long _fail; // Count failed test methods for all test classes
	...
	public:
		...
		__declspec(dllexport) void List(const string & test) const;
