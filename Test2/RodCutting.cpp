...
namespace My {
	...
	void RodCutting::ComputeFirstCut(const vector<double> & utility, vector<double> & maxUtility, vector<int> & firstCut)
	{
	...
	// n        f_n    n-f_n-1
	// n-f_n-1
	void RodCutting::PrintResult(const vector<double> & utility)
	{
